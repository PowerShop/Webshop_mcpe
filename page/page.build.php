...
?>
<!DOCTYPE HTML>
<title> ร้านค้า | สิ่งของสำหรับก่อสร้าง </title>
...
<center>
                <h1><legend style="color: white"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ร้านค้า | สิ่งของสำหรับก่อสร้าง</legend></h1>
</center>
               
                    
<div class="center">
                    <?php $query = "SELECT * FROM `item` WHERE page = 5 ORDER BY id";
