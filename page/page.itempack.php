...
?>
<!DOCTYPE HTML>
<title> ร้านค้า | ไอเท็มแพ็ค </title>
...
<center>
                <h1><legend style="color: white"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ร้านค้า | รออัพเดพ</legend></h1>
</center>
               
                    
<div class="center">
                    <?php $query = "SELECT * FROM `item` WHERE page = 8 ORDER BY id";
