...
<center>
                <h1><legend style="color: white"><i class="fa fa-shopping-cart" aria-hidden="true"></i> ร้านค้า | เงินในเกม</legend></h1>
</center>
               
                    
<div class="center">
                    <?php $query = "SELECT * FROM `item` WHERE page = 6 ORDER BY id";
